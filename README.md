...
전자공시시스템(DART)의 대규모 기업 재무정보를 수집하고, 기업마다 제각각인 계정과목 표기를 표준화한 뒤, 산업별 상대지표를 반영해 기업의 부실위험을 스코어링합니다. 실제 관리종목 지정 및 상장폐지 이력과 대조 검증하여, 예측 스코어가 실제 부실 사례를 얼마나 정확히 포착하는지까지 확인했습니다.
...
전체 상장사의 상위 10퍼센트만 집중 모니터링해도, 실제 부실 사례의 52.3퍼센트를 조기에 포착할 수 있음을 실측 데이터로 검증했습니다.
